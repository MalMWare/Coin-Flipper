...
let message = document.querySelector("#result") //getElement("result")
let flipButton = document.querySelector("#flip")
let headsArea = document.querySelector("#heads")
let headsPerArea = document.querySelector("#heads-percent")
let tailsArea = document.querySelector("#tails")
let tailsPerArea = document.querySelector("#tails-percent")
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    flipButton.addEventListener("click", function(e) {
        //calculate totza number of rolls/flips
        totalFlips ++
        ...
        headsPerArea.textContent = `${percentHeads}%`
        tailsArea.textContent = `${numberTails}`
        tailsPerArea.textContent = `${percentTails}%`
    })
